  ...
  return (
    <div
      ...
      <div className="mt-4 text-center max-w-md">
        <h1 className="mb-4 text-2xl md:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-500 to-yellow-400 animate-gradient">
          Welcome to Run Club For-MFS-That Don't Run Orlando
        </h1>
        <p className="text-gray-400 text-sm md:text-base">
          Orlando's Run Club that's light hearted, shorter routes, and casual 🏃‍♂️💨. Come join us for the next run - Everyone is WELCOMED!!
        </p>
      </div>
    </div>
  );
